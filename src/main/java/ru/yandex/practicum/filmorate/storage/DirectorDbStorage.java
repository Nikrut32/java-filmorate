...
public class DirectorDbStorage extends BaseDbStorage<Director> implements DirectorStorage {
    ...
    private static final String GET_BY_ID_QUERY = "SELECT director_id, name FROM directors WHERE director_id = ?";

    private static final String GET_ALL_QUERY = "SELECT director_id, name FROM directors ORDER BY director_id";
    ...
    public DirectorDbStorage(JdbcTemplate jdbc, RowMapper<Director> rowMapper) {
    ...
    public void removeDirector(long directorId) {
        ...
        delete(true, DELETE_QUERY, directorId);
    }

    @Override
    public Director getDirectorById(long directorId) {
        return findOne(GET_BY_ID_QUERY, directorId).orElseThrow(() -> new ValidationNotObjectException("Режиссёр с id: " + directorId + " не найден"));
    }
    ...
    public boolean checkingId(long directorId) {
        return findOne(GET_BY_ID_QUERY, directorId).isPresent();
    }
}