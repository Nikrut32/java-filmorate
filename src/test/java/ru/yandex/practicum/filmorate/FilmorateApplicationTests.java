...
class FilmorateApplicationTests {
    ...
    void getTopFilmsTestCountTwo() {
        ...
        testFilm2.setId(2L);
        testFilm3.setId(3L);
        String jsonString = gson.toJson(new LinkedHashSet<>(List.of(testFilm1, testFilm2, testFilm3)));
    ...
    void putUserAddFriendAndGetFriendsTest() {
        ...
        ResponseEntity<Void> responsePutTwo = restTemplate.exchange(
                baseUrl("users/2/friends/1"),
                HttpMethod.PUT,
                HttpEntity.EMPTY,
                Void.class
        );
    ...
    void getAllGenresTest() {
        List<Genre> genres = new LinkedList<>(List.of(
        ...
        String expectedJson = gson.toJson(genres);
        String actualJson = responseGet.getBody();

        assertEquals(gson.fromJson(expectedJson, Object.class),
                    gson.fromJson(actualJson, Object.class)
        );
    }
    ...
    void getGenreByIdTest() {
        ...
        String expectedJson = gson.toJson(genre);
        String actualJson = responseGet.getBody();
    ...
    @Test
    void getAllMpaTest() {
        List<Mpa> mpa = new LinkedList<>(List.of(
        ...
        String expectedJson = gson.toJson(mpa);
        String actualJson = responseGet.getBody();
